 ...
 * @ref GPCRC_InitCommand function. This function will reset the CRC calculation
 ...
 * <b> Examples of GPCRC usage: </b>
  ...
  GPCRC_InitCommand();
  GPCRC_InputU8(0xAB);
  checksum = (uint16_t) GPCRC_DataRead();
  @endverbatim
 * @{
 ******************************************************************************/
 ...
 *   to @ref GPCRC_InitCommand before each calculation, or by using the
